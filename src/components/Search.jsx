...
const Search = () => {
  ...
  const { playWithId } = useContext(PlayerActionsContext); // Use PlayerActionsContext for playWithId function
  ...
  return (
    <>
      ...
      {filteredSongs.map((item) => (
        <SearchResultItem key={item.id} item={item} playWithId={playWithId} />
      ))}
    </>
  );
};
